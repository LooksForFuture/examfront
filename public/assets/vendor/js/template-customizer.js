  ...
  return (function () {
    ...
    return (
      (function () {
        ...
        (L.THEMES = [
          { name: "theme-default", title: "پیش‌فرض" },
          { name: "theme-semi-dark", title: "نیمه‌تیره" },
          { name: "theme-bordered", title: "دورخط‌دار" },
        ]),
          (L.LANGUAGES = {
            en: {
            ...
            fa: {
              panel_header: "سفارشی‌سازی قالب",
              panel_sub_header: "سفارشی‌سازی کرده و به صورت زنده مشاهده کنید",
              theming_header: "قالب‌بندی",
              theme_header: "قالب",
              theme_label: "قالب‌ها",
              style_label: "استایل (حالت)",
              style_switch_light: "روشن",
              style_switch_dark: "تیره",
              layout_header: "طرح",
              layout_label: "طرح (منو)",
              layout_static: "ایستا",
              layout_offcanvas: "خارج از کادر",
              layout_fixed: "ثابت",
              layout_fixed_offcanvas: "ثابت خارج از کادر",
              layout_flipped_label: "منوی ورق خورده",
              layout_dd_open_label: "منوی کشویی هنگام هاور",
              layout_navbar_label: "نوار ناوبری ثابت",
              layout_footer_label: "فوتر ثابت",
              misc_header: "متفرقه",
              rtl_label: "جهت راست به چپ (RTL)",
            },
            fr: {
